...
FROM llvm_tools_repoadd_source_install as llvm_tools_build_package_export_test_upload

ARG BUILD_TYPE=Release
ARG APT="apt-get -qq --no-install-recommends"
ARG LS_VERBOSE="ls -artl"
ARG CONAN="conan"
ARG PKG_NAME="llvm_tools/master"
ARG PKG_CHANNEL="conan/stable"
ARG PKG_UPLOAD_NAME="llvm_tools/master@conan/stable"
